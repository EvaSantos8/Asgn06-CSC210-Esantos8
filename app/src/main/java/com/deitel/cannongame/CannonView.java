...
public class CannonView extends SurfaceView
   ...
   //contants for the racket
   public static final double RACKET_WIDTH_PERCENT = 2.0 / 40;
    public static final double RACKET_LENGTH_PERCENT = 3.0 / 20;
   ...
   public void newGame() {
      ...
      racket = new Racket(this, Color.DKGRAY, (int)(screenWidth / 1.3), (screenHeight/2),
       (int)(RACKET_WIDTH_PERCENT * screenHeight),(int)(RACKET_LENGTH_PERCENT *screenWidth),1);
      ...
      // add TARGET_PIECES Targets to the Target list
       for(int column = 0; column < 7; column ++ ){
          ...
          targetX = 0;
          targetY += (int) (TARGET_LENGTH_PERCENT * screenHeight) ;
   ...
   public void alignAndFireCannonball(MotionEvent event) {
    ...
    public void alignRacket(MotionEvent event) {
        // get the location of the touch in this view
        Point touchPoint = new Point((int) event.getX(),
                (int) event.getY());
        racket.moveY(touchPoint.y);
      ...
      if (cannon.getCannonball() != null &&
         ...
         for (int n = 0; n < targets.size(); n++) {
            if (cannon.getCannonball().collidesWith(targets.get(n))) {
               ...
               cannon.getCannonball().reverseVelocityX(); // remove Cannonball from game
               cannon.getCannonball().reverseVelocityY();
          ...
          if (cannon.getCannonball().collidesWith(racket)) {
   ...
   public boolean onTouchEvent(MotionEvent e) {
      ...
      if (action == MotionEvent.ACTION_DOWN ||
       ...
       //move racket
       if (action == MotionEvent.ACTION_DOWN ||
               action == MotionEvent.ACTION_MOVE) alignRacket(e);
      return true;
   }
