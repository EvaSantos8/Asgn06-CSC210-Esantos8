...
public class GameElement {
   ...
   float velocityY; // the vertical velocity of this GameElement
   int y;
   int width;
   int length;
   int x;
   // public constructor
   public GameElement(CannonView view, int color, int newX,
      int newY, int newWidth, int newLength, float velocityY) {
      y = newY;
      x = newX;
      width = newWidth;
      length = newLength;
